...
export const listDir = async directory => {
    try {
...
export const listDirR = async directory => {
    try {
        const fsEntries = await fs.promises.readdir(directory, {withFileTypes: true});
        const baseDir = directory;
...
export const applyCondition = (selectFunction) => {
    return files => {
